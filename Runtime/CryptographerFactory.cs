...
namespace OneM.Cryptography
{
    ...
    public static class CryptographerFactory
    {
        ...
        /// <returns>A Cryptographer implementation.</returns>
        public static ICryptographer Create(CryptographerType type, string key) => Create(type, key, StreamFactory.Create());
        ...
        public static ICryptographer Create(CryptographerType type, string key, IStream strem) => type switch
        {
